...
public class Factorial {
    ...
    public static void main(String[] args) {
        // implementacion de los metodos (aqui para la consola)
        System.out.println("Factorial recursivo: " + factorialRecursivo(numero));
        System.out.println("Es mayor a 0: " + esMayorAZero(numero));
        System.out.println("Es entero: " + esEntero(numero));
        System.out.println("Factorial de número grande: " + factorialGrande(numero));
        System.out.println("Es número válido: " + esNumeroValido("10"));
    }
